...
function wp_themeisle_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section('zerif_pro_theme_info', array(
        'title' => __( 'Theme info', 'zerif' ),
        'priority' => 0,
    ) );
    $wp_customize->add_setting('zerif_pro_theme_info', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'zerif_pro_sanitize_input',
    ) );
    $wp_customize->add_control( new Zerif_Pro_Info( $wp_customize, 'zerif_pro_theme_info', array(
    ...
    if ( class_exists( 'WP_Customize_Panel' ) ):
        ...
        $wp_customize->add_setting( 'zerif_add_thumbnail_posts', array(
            'sanitize_callback' => 'zerif_sanitize_checkbox'
        ) );

        $wp_customize->add_control( 'zerif_add_thumbnail_posts', array(
            'type' 		=> 'checkbox',
        ...
        $wp_customize->add_setting( 'zerif_add_thumbnail_pages', array(
            'sanitize_callback' => 'zerif_sanitize_checkbox'
        ) );

        $wp_customize->add_control( 'zerif_add_thumbnail_pages', array(
            'type' 		=> 'checkbox',
    ...
    if ( class_exists( 'WP_Customize_Panel' ) ) :
        ...
        $wp_customize->add_setting( 'zerif_aboutus_feature1_color', array(
            'default' => apply_filters( 'zerif_aboutus_feature1_color_filter','#E96656' ),
            'sanitize_callback' => 'sanitize_hex_color'
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'zerif_aboutus_feature1_color', array(
            'label'      => __( 'Knob Color', 'zerif' ),
            'section'    => 'zerif_aboutus_feature1_section',
            'priority'   => 4
        ) ) );
        ...
        $wp_customize->add_setting( 'zerif_aboutus_feature2_color', array(
            'default' => apply_filters( 'zerif_aboutus_feature2_color_filter','#34D293' ),
            'sanitize_callback' => 'sanitize_hex_color'
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'zerif_aboutus_feature2_color', array(
            'label'      => __( 'Knob Color', 'zerif' ),
            'section'    => 'zerif_aboutus_feature2_section',
            'priority'   => 4
        ) ) );
        ...
        $wp_customize->add_setting( 'zerif_aboutus_feature3_color', array(
            'default' => apply_filters( 'zerif_aboutus_feature3_color_filter','#3AB0E2' ),
            'sanitize_callback' => 'sanitize_hex_color'
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'zerif_aboutus_feature3_color', array(
            'label'      => __( 'Knob Color', 'zerif' ),
            'section'    => 'zerif_aboutus_feature3_section',
            'priority'   => 4
        ) ) );
        ...
        $wp_customize->add_setting( 'zerif_aboutus_feature4_color', array(
            'default' => apply_filters( 'zerif_aboutus_feature4_color_filter','#E7AC44' ),
            'sanitize_callback' => 'sanitize_hex_color'
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'zerif_aboutus_feature4_color', array(
            'label'      => __( 'Knob Color', 'zerif' ),
            'section'    => 'zerif_aboutus_feature4_section',
            'priority'   => 4
        ) ) );
    ...
    if ( class_exists( 'WP_Customize_Panel' ) ) :
        ...
        $zerif_pirate_forms_settings = '';
        if ( defined( 'PIRATE_FORMS_VERSION' ) ) {
            $zerif_pirate_forms_settings = '<div class="zerif-pirate-forms-settings"><p>' . sprintf( __( 'To have access to more customization options for the contact us section please visit the %s settings page.', 'zerif' ), sprintf( '<a href="' . esc_url( "options-general.php?page=pirate-forms-admin" ) . '" target="_blank" >%s</a>', esc_html__( 'Pirate Forms', 'zerif' ) ) ) . '</p></div>';
        }

        $wp_customize->add_section( 'zerif_contactus_settings_section' , array(
            'title'       => __( 'Settings', 'zerif' ),
            'description' => $zerif_pirate_forms_settings,
            'priority'    => 1,
            'panel' => 'panel_10'
        ));
    ...
    if ( class_exists( 'WP_Customize_Panel' ) ) :
        ...
        $wp_customize->add_setting( 'zerif_package_title_color', array(
            'default' => apply_filters( 'zerif_package_title_color_filter','#fff' ),
            'transport' => 'postMessage',
            'sanitize_callback' => 'sanitize_hex_color'
        ) );
...
function wp_themeisle_customize_preview_js() {
    wp_enqueue_script( 'wp_themeisle_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '1.0.2', true );
