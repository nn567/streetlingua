 ...
 */
function zerif_before_header_trigger() {
	do_action( 'zerif_before_header' );
}

/**
 * Top of header
 *
 * HTML context: within `header`
 */
function zerif_top_header_trigger() {
	do_action( 'zerif_top_header' );
}
 ...
 * HTML context: within `header`
 */
function zerif_bottom_header_trigger() {
	do_action( 'zerif_bottom_header' );
}
 ...
 *
 * HTML context: inside `.newsletter`
 */
function zerif_subscribe_header_title_trigger() {
	do_action( 'zerif_subscribe_header_title' );
}
 ...
 * HTML context: inside `.newsletter`
 */
function zerif_subscribe_header_subtitle_trigger() {
	do_action( 'zerif_subscribe_header_subtitle' );
}
...
/**
 * Add the main navigation menu - when accessibility option is set
 */
function zerif_primary_navigation_accessibility_trigger() {
	do_action( 'zerif_primary_navigation_accessibility' );
}
/************ Archive *****************/
...
/**
 * After button in Ribbon with bottom button
 *
 * HTML context: in `#ribbon_bottom .color-overlay`
 */
function zerif_ribbon_with_bottom_button_after_button_trigger() {
	do_action( 'zerif_ribbon_with_bottom_button_after_button' );
}