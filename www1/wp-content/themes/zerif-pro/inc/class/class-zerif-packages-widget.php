		...
		<div class="package-box-wrap col-lg-3 col-md-6 col-sm-6">
			...
			<div class="package" data-scrollreveal="enter left after 0s over 1s">
				...
				if( !empty($instance['button_label']) && !empty($instance['button_link']) ) {
					...
					<a target="<?php echo wp_kses_post( $zerif_packages_target ); ?>" href="<?php echo esc_url( $instance['button_link'] ); ?>" class="btn btn-primary custom-button" <?php echo $color; ?>>
						<?php
						...
						echo wp_kses_post( $instance['button_label'] ); ?>
					</a>
					<?php
				} ?>
